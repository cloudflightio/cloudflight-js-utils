...
export {ContinuingReadProvider, CancellingReadProvider} from './lib/read-providers';
...
export {ContinuingPipeOperator, CancellingPipeOperator, PipeOperator} from './lib/util/pipe.operator';
