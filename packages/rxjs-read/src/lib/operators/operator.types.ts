...
export type ReturnTypeOfTailOperator<Operators extends readonly PipeOperator<any, any>[]> = Tail<Operators> extends PipeOperator<
    any,
    infer R
>
    ? R
...
> = Length extends 1
    ...
    ? [
          First extends PipeOperator<any, infer FR> ? PipeOperator<T, FR> : never,
          ...OperatorPipeline<
